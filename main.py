...
@click.option('--default_file', default='data/Default', help='Path to the default file')
@click.option('--show-all', is_flag=True, default=False, help="Display all settings")
